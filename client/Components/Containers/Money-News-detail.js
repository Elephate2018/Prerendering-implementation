...
import fortune from '../../../public/DataToJson/fortune.json';
import openSocket from 'socket.io-client';
const  socket = openSocket('http://localhost:8080');

class MoneyNewsDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            messages: []
    ...
    subscribeToTimer(cb) {
      socket.on('money', data => cb(null, data));
...
export default MoneyNewsDetail;
